...
```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/?scenario=forced_mid_play_rebuffer&e2e_autoplay=1
Call log:
  - navigating to "http://localhost:3000/?scenario=forced_mid_play_rebuffer&e2e_autoplay=1", waiting until "load"
...
> 186 |     await page.goto('/?scenario=forced_mid_play_rebuffer&e2e_autoplay=1');
  ...
  210 |       // Segment errors should be below 50% — scenario injects a *stall*, not a hard failure
  211 |       expect(segErrorRate).toBeLessThan(50);
  212 |     });
  213 |   });
  214 | 
  215 | });
