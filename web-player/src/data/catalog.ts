...
export interface Video {
  ...
  hlsUrl: string;
  /** CSS gradient used as the "thumbnail" and detail backdrop */
  gradient: string;
  accentColor: string;
...
export const CATALOG: CatalogRow[] = [
  ...
  {
    id: 'qoe-scenarios',
    label: 'QoE Demo Scenarios',
    videos: [
      {
        id: 'qoe-baseline',
        title: 'Crystal Clear',
        description: 'Reference stream — flawless adaptive bitrate, zero stalls, perfect QoE.',
        longDescription: 'The gold standard of streaming. Crystal Clear serves as the baseline reference for all QoE measurements. A smooth adaptive bitrate experience with no stalls, no bitrate drops, and first-frame delivery in under 3 seconds. This is what your streaming platform should look like.',
        genre: 'QoE Demo',
        subGenres: ['Baseline', 'Reference'],
        year: 2024,
        rating: 'G',
        durationLabel: 'Demo',
        hlsUrl: STREAMS.bigBuckBunny,
        gradient: 'linear-gradient(135deg, #003a00 0%, #006600 60%, #00ff88 100%)',
        accentColor: '#00ff88',
        scenario: 'baseline',
        matchScore: 100,
      },
      {
        id: 'qoe-startup-delay',
        title: 'The Delay',
        description: 'Simulated startup latency — 2.8 s manifest attach delay. How patient are your users?',
        longDescription: 'Startup latency is one of the most damaging QoE metrics — 47% of viewers abandon a stream that takes more than 3 seconds to start. The Delay artificially injects a 2.8 second pause before the HLS manifest is attached, allowing you to measure time-to-first-frame and validate your quality gates against real-world startup degradation.',
        genre: 'QoE Demo',
        subGenres: ['Startup', 'Latency'],
        year: 2024,
        rating: 'G',
        durationLabel: 'Demo',
        hlsUrl: STREAMS.bigBuckBunny,
        gradient: 'linear-gradient(135deg, #1a1a00 0%, #4a4a00 60%, #ffcc00 100%)',
        accentColor: '#ffcc00',
        scenario: 'startup_delay',
        matchScore: 72,
      },
      {
        id: 'qoe-blackout',
        title: 'Blackout',
        description: 'Visual fault injection — a 1.6 s black overlay simulating a decoder freeze.',
        longDescription: 'Visual artifacts are invisible to server-side monitoring but catastrophic to viewer experience. Blackout injects a 1.6 second opaque black overlay at 3.5 seconds into playback, simulating a GPU decoder stall or frame corruption event. CI visual probes catch this; server logs never do.',
        genre: 'QoE Demo',
        subGenres: ['Visual Fault', 'Black Screen'],
        year: 2024,
        rating: 'G',
        durationLabel: 'Demo',
        hlsUrl: STREAMS.bigBuckBunny,
        gradient: 'linear-gradient(135deg, #0a0000 0%, #2a0000 60%, #8b0000 100%)',
        accentColor: '#cc0000',
        scenario: 'black_screen_pulse',
        matchScore: 61,
      },
      {
        id: 'qoe-rebuffer',
        title: 'The Stall',
        description: 'Mid-play rebuffering — HLS segment loading halted for 2.2 s at the 4-second mark.',
        ...
        genre: 'QoE Demo',
        subGenres: ['Rebuffering', 'Stall'],
        year: 2024,
        rating: 'G',
        durationLabel: 'Demo',
        hlsUrl: STREAMS.bigBuckBunny,
        gradient: 'linear-gradient(135deg, #00101a 0%, #003050 60%, #0055aa 100%)',
        accentColor: '#0088ff',
        scenario: 'forced_mid_play_rebuffer',
        matchScore: 65,
      },
      {
        id: 'qoe-bitrate',
        title: 'Signal Loss',
        description: 'Bitrate instability — forced ABR step-down then recovery. Quality oscillation in action.',
        longDescription: 'Adaptive bitrate switching is a feature — but uncontrolled oscillation between quality levels creates visible staircase artefacts and viewer distress. Signal Loss forces hls.js to step down to the lowest quality level at 2 seconds and recover after 2.5 seconds, giving you a controlled environment to validate your bitrate-switch quality gates.',
        genre: 'QoE Demo',
        subGenres: ['Bitrate', 'ABR'],
        year: 2024,
        rating: 'G',
        durationLabel: 'Demo',
        hlsUrl: STREAMS.bigBuckBunny,
        gradient: 'linear-gradient(135deg, #1a001a 0%, #4a004a 60%, #cc00cc 100%)',
        accentColor: '#ff00ff',
        scenario: 'bitrate_step_down',
        matchScore: 69,
      },
    ],
  },
